...
if (!isset($_SESSION["logged_in"]) || $_SESSION["logged_in"] !== 'buchhaltung') {
...
$sql = "SELECT vertrag_id, vertragsbeginndatum, bemerkungen FROM vertraege";
...
<nav class="navbar bg-body-tertiary fixed-top">
        ...
        <div class="offcanvas-body">
            ...
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="h_buchhaltung.php" aria-current="page">Home</a>
                </li>
